...
def train(df, S, Y, S_under, Y_desire, epochs=500, batch_size=64, fair_epochs=10, lamda=0.5):
...
def train_plot(df, S, Y, S_under, Y_desire, epochs, fair_epochs, lamda, batchsize=256):
    generator, critic, ohe, scaler, data_train, data_test, input_dim = train(
        df, S, Y, S_under, Y_desire, epochs, batchsize, fair_epochs, lamda)
    return generator, critic, ohe, scaler, data_train, data_test, input_dim
